...
export const SURVEY_AXES: SurveyAxis[] = [
  {
    ...
    shortName: "Física",
    description:
      "Vitalidade, mobilidade, nutrição, sono reparador e hábitos preventivos para o corpo.",
    questions: [
      {
        id: "SF01",
        sourceCode: "Q003",
  ...
  },
  {
    ...
    shortName: "Emocional",
    description:
      "Equilíbrio interior, autorreflexão, serenidade e capacidade de lidar com transições.",
    questions: [
      {
        id: "SE01",
        sourceCode: "Q004",
      ...
      },
      {
        ...
        isDemonstrative: false,
        sourceNote:
          "Adaptação de Q029 para uso universal (sem restrição de aposentadoria).",
      },
    ],
  },
  {
    ...
    shortName: "Vínculos",
    description:
      "Laços familiares, amizades duradouras, convivência comunitária e pertencimento.",
    questions: [
      {
        id: "RE01",
        sourceCode: "Q033",
  ...
  },
  {
    ...
    shortName: "Propósito",
    description:
      "Projetos de vida, mentoria, voluntariado, aprendizagem contínua e realizações.",
    questions: [
      {
        id: "TP01",
        sourceCode: "Q021",
  ...
  },
  {
    ...
    shortName: "Sentido",
    description:
      "Conexão com valores profundos, transcendência, paz de espírito e filosofia de vida.",
    questions: [
      {
        id: "ES01",
        sourceCode: "Q037",
  ...
  },
  {
    ...
    shortName: "Lazer",
    description:
      "Momentos prazerosos, viagens, manifestações culturais, hobbies e descanso.",
    questions: [
      {
        id: "LC01",
        sourceCode: "Q035",
  ...
  },
  {
    ...
    shortName: "Finanças",
    description:
      "Segurança econômica, organização orçamentária, planejamento de gastos e legado.",
    questions: [
      {
        id: "RF01",
        sourceCode: "Q013",
  ...
  },
  {
    ...
    shortName: "Moradia",
    description:
      "Conforto, segurança, acessibilidade do lar e harmonia com a vizinhança.",
    questions: [
      {
        id: "MO01",
        sourceCode: "Q025",
